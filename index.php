                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="team-box mt-4 position-relative overflow-hidden rounded text-center shadow">
                            ...
                            <div class="p-4">
    <h5 class="font-size-19 mb-1" id="name"></h5>
    <p class="text-muted text-uppercase font-size-14 mb-0" id="position"></p>
    <p class="text-muted text-uppercase font-size-10 mb-0" id="description"></p>
</div>
                        </div>
                    </div>
                    <!-- end col -->
                            <div class="p-4">
                                ...
                                <h5 class="font-size-19 mb-1"><?php echo ['firstname'[0]]?></h5>
                                <p class="text-muted text-uppercase font-size-14 mb-0"></p>
